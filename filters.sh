...
python3 /filters-maker/maker-rpz.py /filters-maker/input/excluded.txt /filtes-maker/input/domains.txt /repros/Private-Build/$INPUT_DESTINATION_VERSION/rpz.txt
cd /repros
