...
cp /filters-maker/maker-rpz.py /repros/maker-rpz.py
cp /filters-maker/maker-domains.py /repros/maker-domains.py
python3 /filters-maker/$INPUT_ACTION_FILE
rm /repros/crawler.py
rm /repros/maker-rpz.py
rm /repros/maker-domains.py
